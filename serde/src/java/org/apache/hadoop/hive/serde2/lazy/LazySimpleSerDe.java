...
public class LazySimpleSerDe extends AbstractEncodingAwareSerDe {
  ...
  public void initialize(Configuration job, Properties tbl)
	...
	//this is temporary. only to test whether thriftExecSerDe has the right initialize() and serialize/deserialize() methods written. once we confirm, we will initialize using the table_desc in SemanticAnalyzer.genFileSinkPlan()
