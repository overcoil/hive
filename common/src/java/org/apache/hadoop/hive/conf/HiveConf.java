...
public class HiveConf extends Configuration {
  ...
  public static enum ConfVars {
    ...
    HIVE_SERVER2_RESULTSET_COMPRESSOR_DISABLE("hive.resultSet.compressor.disable","", "Disabled compressors"),
    HIVE_SERVER2_RESULTSET_COMPRESSOR_ENABLED("hive.resultset.compression.enabled", true, "Whether to enable result set compression");
