            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.confOverlay = new HashMap<String,String>(2*_map170.size);
                String _key171;
                String _val172;
                for (int _i173 = 0; _i173 < _map170.size; ++_i173)
                {
                  ...
                  struct.confOverlay.put(_key171, _val172);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.confOverlay = new HashMap<String,String>(2*_map176.size);
          String _key177;
          String _val178;
          for (int _i179 = 0; _i179 < _map176.size; ++_i179)
          {
            ...
            struct.confOverlay.put(_key177, _val178);
          }
        }
        struct.setConfOverlayIsSet(true);
      }
