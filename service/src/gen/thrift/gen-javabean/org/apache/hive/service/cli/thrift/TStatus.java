            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.infoMessages = new ArrayList<String>(_list142.size);
                String _elem143;
                for (int _i144 = 0; _i144 < _list142.size; ++_i144)
                {
                  _elem143 = iprot.readString();
                  struct.infoMessages.add(_elem143);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.infoMessages = new ArrayList<String>(_list147.size);
          String _elem148;
          for (int _i149 = 0; _i149 < _list147.size; ++_i149)
          {
            _elem148 = iprot.readString();
            struct.infoMessages.add(_elem148);
          }
        }
        struct.setInfoMessagesIsSet(true);
      }
