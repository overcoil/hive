            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tableTypes = new ArrayList<String>(_list180.size);
                String _elem181;
                for (int _i182 = 0; _i182 < _list180.size; ++_i182)
                {
                  _elem181 = iprot.readString();
                  struct.tableTypes.add(_elem181);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.tableTypes = new ArrayList<String>(_list185.size);
          String _elem186;
          for (int _i187 = 0; _i187 < _list185.size; ++_i187)
          {
            _elem186 = iprot.readString();
            struct.tableTypes.add(_elem186);
          }
        }
        struct.setTableTypesIsSet(true);
      }
