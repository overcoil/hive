...
public class TRowSet implements org.apache.thrift.TBase<TRowSet, TRowSet._Fields>, java.io.Serializable, Cloneable, Comparable<TRowSet> {
  ...
  private static final _Fields optionals[] = {_Fields.COLUMNS,_Fields.EN_COLUMNS,_Fields.COMPRESSOR_BITMAP};
  ...
  public TRowSet(TRowSet other) {
    ...
    if (other.isSetEnColumns()) {
      List<TEnColumn> __this__enColumns = new ArrayList<TEnColumn>(other.enColumns.size());
  ...
  public ByteBuffer bufferForCompressorBitmap() {
    return org.apache.thrift.TBaseHelper.copyBinary(compressorBitmap);
  }

  public void setCompressorBitmap(byte[] compressorBitmap) {
    this.compressorBitmap = compressorBitmap == null ? (ByteBuffer)null : ByteBuffer.wrap(Arrays.copyOf(compressorBitmap, compressorBitmap.length));
  }

  public void setCompressorBitmap(ByteBuffer compressorBitmap) {
    this.compressorBitmap = org.apache.thrift.TBaseHelper.copyBinary(compressorBitmap);
  }
  ...
  public int compareTo(TRowSet other) {
    ...
    lastComparison = Boolean.valueOf(isSetEnColumns()).compareTo(other.isSetEnColumns());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEnColumns()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.enColumns, other.enColumns);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCompressorBitmap()).compareTo(other.isSetCompressorBitmap());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCompressorBitmap()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.compressorBitmap, other.compressorBitmap);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  _elem125 = new TEnColumn();
                  _elem125.read(iprot);
                  struct.enColumns.add(_elem125);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          {
            _elem140 = new TEnColumn();
            _elem140.read(iprot);
            struct.enColumns.add(_elem140);
          }
        }
        struct.setEnColumnsIsSet(true);
      }
