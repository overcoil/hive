            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.configuration = new HashMap<String,String>(2*_map150.size);
                String _key151;
                String _val152;
                for (int _i153 = 0; _i153 < _map150.size; ++_i153)
                {
                  ...
                  struct.configuration.put(_key151, _val152);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.configuration = new HashMap<String,String>(2*_map156.size);
          String _key157;
          String _val158;
          for (int _i159 = 0; _i159 < _map156.size; ++_i159)
          {
            ...
            struct.configuration.put(_key157, _val158);
          }
        }
        struct.setConfigurationIsSet(true);
      }
