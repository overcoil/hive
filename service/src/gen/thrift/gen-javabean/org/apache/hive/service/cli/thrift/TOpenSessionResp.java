            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i163 = 0; _i163 < _map160.size; ++_i163)
                {
                  ...
                  struct.configuration.put(_key161, _val162);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.configuration != null) {
        if (struct.isSetConfiguration()) {
          oprot.writeFieldBegin(CONFIGURATION_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter164 : struct.configuration.entrySet())
            {
      ...
      if (struct.isSetConfiguration()) {
        {
          ...
          for (Map.Entry<String, String> _iter165 : struct.configuration.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          for (int _i169 = 0; _i169 < _map166.size; ++_i169)
          {
            ...
            struct.configuration.put(_key167, _val168);
          }
        }
        struct.setConfigurationIsSet(true);
      }
