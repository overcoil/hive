...
class TEnColumn:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.enData)
    value = (value * 31) ^ hash(self.nulls)
    value = (value * 31) ^ hash(self.type)
...
class TRowSet:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.columns)
    value = (value * 31) ^ hash(self.enColumns)
    value = (value * 31) ^ hash(self.compressorBitmap)
    return value
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i129 in xrange(_size125):
            ...
            self.infoMessages.append(_elem130)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i136 in xrange(_size132):
            ...
            self.configuration[_key137] = _val138
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i145 in xrange(_size141):
            ...
            self.configuration[_key146] = _val147
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i154 in xrange(_size150):
            ...
            self.confOverlay[_key155] = _val156
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i163 in xrange(_size159):
            ...
            self.tableTypes.append(_elem164)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
